 ...
 */
const parseStorage = (umlClass, umlClasses, storages, storageObjects) => {
    ...
    umlClass.attributes.forEach((attribute) => {
        ...
        const linkedStruct = exports.parseStructStorageObject(attribute, umlClasses, storageObjects);
        const structObjectId = linkedStruct === null || linkedStruct === void 0 ? void 0 : linkedStruct.id;
