...
If an Ethereum address with a 0x prefix is passed, the verified source code from Etherscan will be used. For example
    ...
    .option('-ha, --hideAttributes', 'hide class and interface attributes/variables', false)
    .option('-ho, --hideOperators', 'hide class and interface operators/functions', false)
